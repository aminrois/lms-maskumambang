  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        onInteractOutside={(e) => {
          // Cegah dialog menutup saat user pindah tab browser dan kembali.
          // Hanya izinkan penutupan dari klik pada overlay (DialogOverlay).
          const target = e.target as HTMLElement;
          const isOverlayClick = target?.closest('[data-slot="dialog-overlay"]');
          if (!isOverlayClick) {
            e.preventDefault();
          }
        }}
